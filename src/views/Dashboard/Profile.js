          ...
          <CardHeader p="12px 5px" mb="12px">
            <Flex direction="column">
              ...
              <Text fontSize="sm" color="gray.400">
                Hello, Supriya maddu! Your Car is ready.
              </Text>
            </Flex>
          </CardHeader>
          <CardBody w="100%">
          ...
          <CardBody px="5px">
            <Flex direction="column">
              <Text fontSize="sm" color={"gray.400"} fontWeight="400" mb="15px">
                Hi, I’m Supriya maddu, Decisions: If you can’t decide, the answer
